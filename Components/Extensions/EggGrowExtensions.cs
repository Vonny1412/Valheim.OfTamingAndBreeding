...
namespace OfTamingAndBreeding.Components.Extensions
{
    internal static class EggGrowExtensions
    {
        ...
        public static ZNetView GetZNetView(this EggGrow that)
            => ValheimAPI.EggGrow.__IAPI_m_nview_Invoker.Get(that);
        ...
        public static ItemDrop GetItemDrop(this EggGrow that)
            => ValheimAPI.EggGrow.__IAPI_m_item_Invoker.Get(that);
        ...
        public static void Start_PatchPostfix(this EggGrow eggGrow)
        {
            ...
            if (eggGrow.TryGetComponent<OTAB_EggGrowTrait>(out _) == false)
            {
                // we are using late-registration
                // instead of adding component in CreatureProcessor

                var prefabName = global::Utils.GetPrefabName(eggGrow.gameObject.name);
                var prefab = PrefabManager.Instance.GetPrefab(prefabName);
                var prefabEggGrow = prefab.GetComponent<EggGrow>();

                var c1 = eggGrow.gameObject.gameObject.AddComponent<OTAB_EggGrowTrait>();
                var c2 = prefab.gameObject.AddComponent<OTAB_EggGrowTrait>();
        ...
        private static void UpdateGrowTime(this EggGrow eggGrow, float totalFactor)
        {
            ...
            {
                var trait = eggGrow.GetComponent<OTAB_EggGrowTrait>();
        ...
        public static bool GrowUpdate_PatchPrefix(this EggGrow eggGrow)
        {
            ...
            if (z_EggBehavior == Plugin.ZDOVars.EggBehavior.Unknown)
            {
                ...
                var customEggComponent = eggGrow.GetComponent<OTAB_Egg>();
