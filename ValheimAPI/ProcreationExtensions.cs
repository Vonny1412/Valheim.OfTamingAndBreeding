...
namespace OfTamingAndBreeding.ValheimAPI
{
    internal static class ProcreationExtensions
    {
        ...
        public static ZNetView GetZNetView(this Procreation that)
            => LowLevel.Procreation.__IAPI_m_nview_Invoker.Get(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Tameable GetTameable(this Procreation that)
            => LowLevel.Procreation.__IAPI_m_tameable_Invoker.Get(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Character GetCharacter(this Procreation that)
            => LowLevel.Procreation.__IAPI_m_character_Invoker.Get(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GameObject GetMyPrefab(this Procreation that)
            => LowLevel.Procreation.__IAPI_m_myPrefab_Invoker.Get(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetMyPrefab(this Procreation that, GameObject prefab)
            => LowLevel.Procreation.__IAPI_m_myPrefab_Invoker.Set(that, prefab);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsPregnant(this Procreation that)
            => LowLevel.Procreation.__IAPI_IsPregnant_Invoker1.Invoke(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsDue(this Procreation that)
            => LowLevel.Procreation.__IAPI_IsDue_Invoker1.Invoke(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GameObject GetOffspringPrefab(this Procreation that)
            => LowLevel.Procreation.__IAPI_m_offspringPrefab_Invoker.Get(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetOffspringPrefab(this Procreation that, GameObject prefab)
            => LowLevel.Procreation.__IAPI_m_offspringPrefab_Invoker.Set(that, prefab);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void MakePregnant(this Procreation that)
            => LowLevel.Procreation.__IAPI_MakePregnant_Invoker1.Invoke(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ResetPregnancy(this Procreation that)
            => LowLevel.Procreation.__IAPI_ResetPregnancy_Invoker1.Invoke(that);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BaseAI GetBaseAI(this Procreation that)
            => LowLevel.Procreation.__IAPI_m_baseAI_Invoker.Get(that);
        ...
        public static bool Procreate_PatchPrefix(this Procreation procreation)
        {
            ...
            if (procreation.m_seperatePartner == null) // always try to find new partner if its still empty
            {
                if (creature.HasPartnerList(out var partnerList))
                {
                    ...
                    if (foundPartner)
                    {
                        ...
                        z_partnerPrefab = ZNetHelper.SetString(zdo, Plugin.ZDOVars.z_partnerPrefab, procreation.m_seperatePartner.name, z_partnerPrefab);
                        z_partnerNotSeenSince = ZNetHelper.SetLong(zdo, Plugin.ZDOVars.z_partnerNotSeenSince, 0L, z_partnerNotSeenSince);
            ...
            {
                z_offspringPrefab = ZNetHelper.SetString(zdo, Plugin.ZDOVars.z_offspringPrefab, "", z_offspringPrefab);
                z_offspringLevel = ZNetHelper.SetInt(zdo, Plugin.ZDOVars.z_offspringLevel, procreation.m_minOffspringLevel, z_offspringLevel);
                z_needPartner = ZNetHelper.SetInt(zdo, Plugin.ZDOVars.z_needPartner, 1, z_needPartner);
