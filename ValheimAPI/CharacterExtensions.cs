...
namespace OfTamingAndBreeding.ValheimAPI
{
    ...
    {
        internal sealed class CharacterExtraData : Lifecycle.ExtraData<Character, CharacterExtraData>
        {
        }

        internal static class HoverContext
        {
        ...
        private static void AddDisplayItemsFromYaml(this Character character, List<ConsumableItemDisplay> displayItems, Data.Models.Creature.MonsterAIConsumItemData[] consumeItems, Localization L)
        {
